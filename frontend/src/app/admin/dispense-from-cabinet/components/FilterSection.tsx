      ...
      <CardContent>
        ...
        <div className="space-y-4">
          <div className="space-y-1.5">
            <label htmlFor="dispense-item-keyword" className="text-xs font-medium text-slate-600">
              รหัส/ชื่อเวชภัณฑ์
            </label>
            <div className="relative">
              <Search className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-400" />
              <Input
                id="dispense-item-keyword"
                placeholder="ค้นหา..."
          ...
          <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
            <div className="space-y-1.5">
              <label htmlFor="dispense-start-date" className="text-xs font-medium text-slate-600">
                วันที่เริ่มต้น
              </label>
              <DatePickerBE
                id="dispense-start-date"
            ...
            <div className="space-y-1.5">
              <label htmlFor="dispense-end-date" className="text-xs font-medium text-slate-600">
                วันที่สิ้นสุด
              </label>
              <DatePickerBE
                id="dispense-end-date"
