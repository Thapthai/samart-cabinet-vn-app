...
export default function LogsPage() {
  ...
  const formatDate = (v: string | Date | null | undefined) => {
    if (v == null || v === '') return '-';
    const thOpts: Intl.DateTimeFormatOptions = {
      calendar: 'buddhist',
      year: 'numeric',
      month: 'short',
      day: 'numeric',
    ...
    if (v instanceof Date) {
      ...
      return v.toLocaleString('th-TH', { ...thOpts, timeZone: 'Asia/Bangkok' });
    }
    ...
    if (hasExplicitTz) {
      ...
      return d.toLocaleString('th-TH', { ...thOpts, timeZone: 'UTC' });
    }
    ...
    if (Number.isNaN(d.getTime())) return s;
    return d.toLocaleString('th-TH', { ...thOpts, timeZone: 'Asia/Bangkok' });
  };
