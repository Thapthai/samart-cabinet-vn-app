      ...
      <CardContent>
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-[minmax(0,1fr)_160px] lg:items-end">
          <div className="space-y-1.5 sm:col-span-2 lg:col-span-1">
            <label htmlFor="unit-keyword" className="text-xs font-medium text-slate-600">
              คำค้นหา
            </label>
          ...
          <div className="space-y-1.5">
            <label htmlFor="unit-status-filter" className="text-xs font-medium text-slate-600">
              สถานะ
            </label>
            <Select value={statusFilter} onValueChange={(v) => onStatusFilterChange(v as UnitStatusFilter)}>
              <SelectTrigger id="unit-status-filter" className={cn('h-10 w-full shadow-sm', fieldInputClass)}>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
