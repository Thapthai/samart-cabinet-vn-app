          ...
          {isCreate ? (
            <>
              <div className="space-y-2">
                <Label htmlFor="staff-cu-userName">ชื่อ (UserName) *</Label>
                <Input
                  id="staff-cu-userName"
                  value={userName}
              ...
              <div className="space-y-2">
                <Label htmlFor="staff-cu-emp">รหัสพนักงาน (EmpCode)</Label>
                <Input
                  id="staff-cu-emp"
                  value={empCode}
            ...
            <>
              <div className="space-y-2">
                <Label htmlFor="staff-cu-userName-ro">ชื่อ (UserName)</Label>
                <Input
                  id="staff-cu-userName-ro"
                  readOnly
                  tabIndex={-1}
                  value={userName}
              ...
              <div className="space-y-2">
                <Label htmlFor="staff-cu-emp-ro">รหัสพนักงาน (EmpCode)</Label>
                <Input
                  id="staff-cu-emp-ro"
                  readOnly
                  tabIndex={-1}
