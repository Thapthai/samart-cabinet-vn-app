        ...
        <div ref={dropdownSlotRef} className="relative flex min-h-0 flex-1 flex-col p-6 pb-2">
          ...
          <div className="grid gap-3 py-2 overflow-y-auto flex-1 pr-1 min-h-0">
            ...
            <div className="space-y-2">
              <Label htmlFor="staff-sd-code">รหัส (code)</Label>
              <Input
                id="staff-sd-code"
                value={formCode}
            ...
            <div className="space-y-2">
              <Label htmlFor="staff-sd-label">ชื่อแสดง</Label>
              <Input
                id="staff-sd-label"
                value={formLabel}
            ...
            <div className="space-y-2">
              <Label htmlFor="staff-sd-desc">รายละเอียด</Label>
              <Textarea
                id="staff-sd-desc"
            ...
            <div className="flex items-center justify-between rounded-lg border p-3">
              <Label htmlFor="staff-sd-active">เปิดใช้งาน</Label>
              <Switch id="staff-sd-active" checked={formActive} onCheckedChange={onFormActiveChange} />
            </div>
          </div>
