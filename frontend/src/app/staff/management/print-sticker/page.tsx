      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500 mt-0.5">
            เลือกหลาย Item จาก master แล้วส่ง ไปเครื่องปริ้น — ที่อยู่เครื่องตั้งใน
          </p>
        </div>
      </div>

      <div className="grid items-start gap-6 lg:grid-cols-3">
        <Card className="min-h-0 min-w-0 border-slate-200 shadow-sm lg:col-span-2">
        ...
        <div className="space-y-4 lg:col-span-1">
          <Card className="border-slate-200 shadow-sm lg:sticky lg:top-4">
            <CardHeader>
              ...
              <CardDescription>
                เครื่องปริ้นใช้ค่า <code className="text-xs bg-slate-100 px-1 rounded">PRINT_STICKER_HOST</code> และ{' '}
                <code className="text-xs bg-slate-100 px-1 rounded">PRINT_STICKER_PORT</code> (ค่าเริ่มต้น 9100) ใน{' '}
